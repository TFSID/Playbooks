...
import CustomBtn from "@/components/scanners/CustomBtn";
...
export default function ScannersPage() {
  ...
  const [selectedOption, setSelectedOption] = useState(""); // 'single' atau 'multiple'
            ...
            <div className=" h-full neon-box-glow-sm hover:neon-box-glow rounded-lg transition-all">
              <div className="card-body">
                ...
                <CustomBtn
                  ...
                  externalUrl="http://127.0.0.1:5000/check-ip"
                />
              </div>
            </div>
